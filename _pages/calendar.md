...
🍞 = Denotes an event that's great if you're DSA-curious!
🌹 = Denotes an event that's only for members in good standing. Check if you're up-to-date with your membership by <a href="mailto:steering@bhamdsa.org?subject=Membership Check">e-mailing the Steering Committee</a>
✊🏿 = Denotes an event that's only for BIPOC (Black, Indigenous, and People of Color) socialists.
